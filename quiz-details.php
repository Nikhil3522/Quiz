      ...
      <div class="relative z-10 px-6">
        ...
        <div class="rounded-2xl overflow-hidden shadow2 mt-16" style="margin-top: 100px;">
          <div class="p-5 bg-white dark:bg-color10">
            <div class="flex justify-between items-center">
              <div class="flex justify-start items-center gap-2">
                <div class="">
                  <p class="font-semibold text-sm">Synonyms and Antonyms Test</p>
                </div>
              </div>
            </div>
            ...
            <?php if(isset($_GET['upcoming']) && $_GET['upcoming'] == true){?>
              <button
            ...
            <?php }else{ ?>
              <button
                class="py-3 text-center bg-p2 rounded-full text-sm font-semibold text-white block confirmationModalOpenButton w-full"
                onclick="window.location.href='quiz.php?quiz_id=31&max_limit=<?php echo $_GET['max_limit']; ?>'"
              >
                Start
              </button>
            <?php }  ?>
        ...
        >
          ...
          <div class="flex justify-start items-center gap-2 pt-3">
            ...
            <p class="text-sm text-color5 dark:text-bgColor5 detailsShort">
              Test your vocabulary with this quiz on similar (synonyms) and opposite (antonyms) words. Sharpen your skills and express ideas more effectively!
              <!-- <button
        ...
        <div class="quizDetailsTab pt-8" style="display: none;">
          ...
          >
            ...
            <li id="tabOne" class="tabButton cursor-pointer">Leaderboard</li>
          </ul>

          <div class="pt-8">
            <div class="tab-content hiddenTab" id="tabOne_data">
            ...
            <div class="tab-content activeTab" id="tabTwo_data">
              <table class="text-sm font-semibold w-full text-center">
                <tr class="bg-p2 text-white w-full">
                  ...
                  <th class="">
                    <p class="py-2 text-nowrap">Points</p>
                  </th>
                  <th class="">
                    <p class="py-2">Rank</p>
                  </th>
